        ...
        {assignments.length === 0 && (
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-sm font-bold text-amber-800">Step required: Assign subjects first</p>
            ...
            <Link
              ...
              className="flex items-center gap-1 text-xs font-bold text-amber-800 bg-amber-100/70 hover:bg-amber-100 transition-colors px-3 py-1.5 rounded-xl flex-shrink-0 whitespace-nowrap"
            >
                ...
                {slots.map((slot, idx) => {
                  ...
                  return (
                    <tr key={idx} className="hover:bg-black/[0.02] transition-colors">
                      ...
                      <td
                        className={`px-4 py-3 border-b border-r border-[rgba(58,44,30,0.12)] align-middle group/period ${assignments.length > 0 ? 'cursor-pointer' : ''}`}
                        style={{ background: 'rgba(58,44,30,0.04)' }}
